...
public class BookRepository {
	...
	public BookRepository() {
		...
		book1.setDescription("워드나 PPT 문서를 만들 수 있나요? 그러면 문제 없습니다 지금바로 웹페이지 제작에 도전해보세요 지금당장 컴퓨터가 없어도 괜찮습니다 코드와 실행화면이 바로 보여서 눈으로만 읽어도 어떻게 작동하는지 쉽게 파악 할 수 있는 것은 기본이고 중간중간 퀴즈를 추가하여 재미있게 게임하듯 복습할 수 있습니다");
		book1.setCategory("Hello Coding");
		book1.setUnitsInStock(1000);
		book1.setTotalPages(288);
		book1.setReleaseDate("2018/03/02");
		book1.setCondition("new");
		book1.setFileName("b1.jpg");
		...
		book2.setName("쉽게 배우는 자바 프로그래밍");
		book2.setUnitPrice(27000);
		book2.setAuthor("우종중");
		book2.setPublisher("한빛아카데미");
		book2.setDescription("객체 지향의 핵심과 자바의 현대적 기능을 충실히 다루면서도 초바자가 쉽게 학습할 수 있게 구성했습니다 시각화 도구를 활용한 개념 설명과 군더더기 없는 핵심 코드를 통해 개념과 구현을 한 흐름으로 학습할수 있습니다 또한 '기초 체력을 다지는 예제 > 셀프 테스트 > 생각을 논리적으로 정리하며 한 단계식 풀어가는 도전 과제 > 스토리가 가미된 흥미로운 프로그래밍문제' 등을 통해 프로그래밍 실력을 차근차근 끌어올릴 수 있습니다");
		book2.setCategory("IT모바일");
		book2.setUnitsInStock(1000);
		book2.setTotalPages(692);
		book2.setReleaseDate("2017/08/02");
		book2.setCondition("new");
		book2.setFileName("b2.jpg");
		
		Book book3 = new Book();
		book3.setBookId("ISBN1236");
		book3.setName("스프링4 입문");
	...
	public boolean deleteBook(String bookId) {
	    ...
	    if (bookToRemove != null) {
	        ...
	        return true; // 도서가 성공적으로 삭제되었음을 반환
	    }

	    System.out.println("Book not found for deletion.");
	    return false; // 도서가 삭제되지 않았음을 반환
	}
